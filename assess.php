...
<div id="tabs">
  <ul>
    ...
    <li><input class="btn btn-primary" type="submit" value="Submit" style="vertical-align:middle"></li>
  </ul>
		...
		<div class="col-md-10 col-md-offset-1 well">
			<fieldset>
				<legend>Welcome to the "Ready to Innovate?" assessment!</legend>
 				...
 				<div class="form-group">
					<p>To complete the assessment, please use the tabs and check the comment which better suits your environment. Once complete, click "Submit" button.</p>
				</div>
			</fieldset>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1 well">
				<fieldset>
					<legend>Development</legend>
					<div class="form-group">
						<table border="0"><tr><td width = "17px" valign="top">
